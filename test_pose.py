...
parser.add_argument("--sequences", default=['08'], type=str, nargs='*', help="sequences to test")
...
def main():
    ...
    from evaluation.pose_val_utils import test_framework_KITTI as test_framework
